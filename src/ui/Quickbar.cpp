...
// --- Owned-scroll custom scrollbar, wheel/page scroll math, and scroll-edge
// hints now live in ui/OwnedScroll.{h,cpp}. The window-resize snap metrics
// above (QbSnap*) stay here - they're window chrome, not scrolling.
